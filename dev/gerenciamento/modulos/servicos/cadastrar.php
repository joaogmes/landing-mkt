<?php
    if(isset($_POST['enviar'])){
        ...
        if(verificarArquivo($imagem)){
            ...
            echo crud('inserir', 'servicos', $dados, $sucesso, $falha, '');
        }else{
            $caminho = "./uploads/";
...
<div class="container">
	<hr>
	<form method="POST" action="./?modulo=servicos&acao=cadastrar" enctype="multipart/form-data">
		<input type="hidden" name="enviar" value="sim">
		<div class="form-row">
			<div class="form-group col-md-4">
				<label for="servico">Nome do serviço*</label>
				<input type="text" class="form-control" name="servico" id="servico" required>
			</div>
			<div class="form-group col-md-4">
